      ...
      <Grid container justify="center">
        ...
        <Grid item xs={10}>
          <div style={{ margin: "20px 0px 20px 0px", fontStyle: "18px" }}>
            Joining our Talent Community is a great way to stay connected to the
            firm, be considered for open roles and be informed about new
        ...
        <Grid item xs={10}>
          ...
          <FormControl variant="outlined" fullWidth margin="normal">
            ...
            >
              ...
              <MenuItem value={"Trade Certificate"}>Trade Certificate</MenuItem>
            </Select>
          </FormControl>
          <FormControl variant="outlined" fullWidth margin="normal">
            <InputLabel id="demo-simple-select-outlined-label">
            ...
            >
              ...
              <MenuItem value={"Corporate Support"}>Corporate Support</MenuItem>
          ...
          <div style={{ marginTop: "10px" }}>
            Upload Your Cover Letter (.rtf, .doc, .docx, .txt, .pdf files with a
