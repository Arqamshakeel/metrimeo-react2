        ...
        <div>
          <strong>
            <span style={{ fontSize: "26px" }}>
              <span data-custom-class="title">TERMS OF USE</span>
            </span>
          </strong>
        </div>
        <div>
          ...
          <span style={{ fontSize: "15px" }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(0, 0, 0)" }}>
                <strong>
                  <span data-custom-class="heading_1">AGREEMENT TO TERMS</span>
                </strong>
              </span>
            </span>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                (“you”) and <bdt className="question">METRIMEO</bdt>
              ...
              <span data-custom-class="body_text">
                ...
                <bdt className="question">METRIMEO</bdt>
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    <bdt className="block-component" />
                  </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                OF AMERICA, international copyright laws, and international
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">USER REPRESENTATIONS</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">PROHIBITED ACTIVITIES</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">CONTRIBUTION LICENSES</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">SUBMISSIONS</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">SITE MANAGEMENT</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">TERM AND TERMINATION</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">GOVERNING LAW</span>
              </strong>
            </span>
          </span>
        </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                of FLORIDA. Your entity and yourself irrevocably consent that
                the courts of Judicial Circuit Courts of FLORIDA shall have
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">DISPUTE RESOLUTION</span>
              </strong>
            </span>
          </span>
        </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                Commercial Rules of the Arbitration Foundation of CEMAC, which,
                as a result of referring to it, is considered as the part of
                this clause. The number of arbitrators shall be two. The seat,
                or legal place, of arbitration shall be FLORIDA. The languages
                of the proceedings shall be FRENCH and ENGLISH. The governing
                law of the contract shall be the substantive law of FLORIDA.
              </span>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">CORRECTIONS</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">DISCLAIMER</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">INDEMNIFICATION</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">USER DATA</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">MISCELLANEOUS</span>
              </strong>
            </span>
          </span>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(0, 0, 0)" }}>
              <strong>
                <span data-custom-class="heading_1">CONTACT US</span>
              </strong>
            </span>
          </span>
        </span>
              ...
              <span data-custom-class="body_text">
                ...
                <strong>
                  <a
                    ...
                    data-cfemail="fa969f9d9b96ba979f8e8893979f95d4999597"
                  >
                    [email&nbsp;protected]
                  </a>
                </strong>
