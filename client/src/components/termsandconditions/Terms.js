              ...
              <strong>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="subtitle">
                    Last updated{" "}
                    <bdt className="question">October 31, 2020</bdt>
                  </span>
                </span>
              </strong>
            </span>
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
                ...
                <span data-custom-class="body_text">
                  ...
                  the <bdt className="question">METRIMEO</bdt>
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      <bdt className="block-component" />
                    </span>
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  of the UNITED STATES OF AMERICA, international copyright laws,
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  or otherwise; (4) you will not use the Site for any illegal or
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  laws of FLORIDA. Your entity and yourself irrevocably consent
                  that the courts of Judicial Circuit Courts of FLORIDA shall
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  resolved by the Commercial Rules of the Arbitration Foundation
                  of CEMAC, which, as a result of referring to it, is considered
                  as the part of this clause. The number of arbitrators shall be
                  two. The seat, or legal place, of arbitration shall be
                  FLORIDA. The languages of the proceedings shall be FRENCH and
                  ENGLISH. The governing law of the contract shall be the
                  substantive law of FLORIDA.
                </span>
              </span>
            </span>
          </span>
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US. CERTAIN US
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span style={{ color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  contact us at: <strong>legal@metrimeo.com</strong>
                </span>
              </span>
            </span>
          </span>
