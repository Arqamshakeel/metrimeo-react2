...
const Security = () => {
  return (
    <div data-custom-class="body" style={{ margin: "0px 40px 0px 40px" }}>
      <div>
        <strong>
          ...
          <strong>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="subtitle">
                Last updated <bdt className="question">October 31, 2020</bdt>
              </span>
            </span>
          </strong>
        </span>
            ...
            <span data-custom-class="body_text">
              ...
              <strong>
                ...
                <a
                  ...
                  data-cfemail="89e5eceee8e5c9e4ecfdfbe0e4ece6a7eae6e4"
                >
                  [email&nbsp;protected]
                </a>{" "}
              </strong>
        ...
        <span style={{ fontSize: "15px" }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span data-custom-class="body_text">
              ...
              visit our website{" "}
              <bdt className="question">
                <a href="../index.htm" target="_blank" data-custom-class="link">
                  https://www.metrimeo.com
                </a>
              </bdt>{" "}
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px" }}>
          <a data-custom-class="link" href="#googlemaps">
            <span style={{ color: "rgb(89, 89, 89)" }}>
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <strong>METRIMEO</strong> does not store your payment data
                  <bdt className="forloop-component" />
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    <span
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        ...
                        <bdt className="question">
                          <a href target="_blank" data-custom-class="link" />
                        </bdt>
                        <span
                          style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}
                        >
                            ...
                            <span style={{ color: "rgb(89, 89, 89)" }}>
                              <span style={{ fontSize: "15px" }}>
                                <span data-custom-class="body_text">
                                  ...
                                  <bdt className="question">
                                    sms messages
                                  </bdt>, <bdt className="forloop-component" />
                                </span>
                              </span>
                            </span>
                          </span>
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  as well as from other third parties. This information includes
                  ...
                  <span style={{ color: "rgb(89, 89, 89)" }}>
                    <span style={{ fontSize: "15px" }}>
                      <span data-custom-class="body_text">
                        ...
                        receive personal information about you such as your
                        name, email address, and gender. Any personal
                          ...
                          <bdt className="question">
                            <strong>
                              <a
                                href="../cdn-cgi/l/email-protection.html"
                                className="__cf_email__"
                                data-cfemail="02617771766d6f6770716770746b6167426f6776706b6f676d2c616d6f"
                              >
                                [email&nbsp;protected]
                              </a>
                            </strong>
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                  ...
                  <span data-custom-class="body_text">
                    ...
                    not include personal information. We will not use
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    ...
                    , which will enable them to collect data on our behalf about
                    ...
                    certain content, pages or features, and better understand
                    ...
                    We have contracts in place with our data processors, which
                    are designed to help safeguard your personal information.
          ...
          <div>
            ...
            <div>
              ...
              <div>
                ...
                <div id="googlemaps" style={{ lineHeight: "1.5" }}>
                  <span style={{ color: "rgb(127, 127, 127)" }}>
                    <span
                      style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}
                    >
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        ...
                        uses Google Maps APIs which is subject to Google’s Terms
                        of Service. You may find the Google Maps APIs Terms of
                        Service
                        <span style={{ fontSize: "15px" }}>
                          <span style={{ color: "rgb(89, 89, 89)" }}>
                        ...
                        . To find out more about Google’s Privacy Policy, please
                        refer to this
                        <span style={{ fontSize: "15px" }}>
                          <span data-custom-class="body_text">
                            <span style={{ color: "rgb(89, 89, 89)" }}>
                        ...
                        at the contact details provided at the end of this
                        document.
                        <span style={{ fontSize: "15px" }}>
                          <span style={{ color: "rgb(89, 89, 89)" }}>
                            <span data-custom-class="body_text">
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        ...
                        <bdt className="block-component" />
                        <bdt className="question">twenty four (24)</bdt> months
                        past the start of idle period of the user's account
                        <bdt className="statement-end-if-in-editor" />
                        <span style={{ fontSize: "15px" }}>
                          <span style={{ color: "rgb(89, 89, 89)" }}>
                            <span data-custom-class="body_text">
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        ...
                        such minor dependent’s use of the{" "}
                        <span
                          style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}
                        >
                          <span data-custom-class="body_text">
                            ...
                            <bdt className="question">
                              <strong>
                                <a
                                  href="../cdn-cgi/l/email-protection.html"
                                  className="__cf_email__"
                                  data-cfemail="026e6765636e426f6776706b6f676d2c616d6f"
                                >
                                  [email&nbsp;protected]
                                </a>
                              </strong>
                              ...
                              <bdt className="question">
                                <strong>
                                  <a
                                    href="../cdn-cgi/l/email-protection.html"
                                    className="__cf_email__"
                                    data-cfemail="05696062646945686071776c68606a2b666a68"
                                  >
                                    [email&nbsp;protected]
                                  </a>
                                </strong>
                            ...
                            <bdt className="question">
                              <strong>
                                <a
                                  href="../cdn-cgi/l/email-protection.html"
                                  className="__cf_email__"
                                  data-cfemail="573b3230363b173a3223253e3a32387934383a"
                                >
                                  [email&nbsp;protected]
                                </a>
                              </strong>
                  ...
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      <span data-custom-class="body_text">
                        ...
                        information, please <bdt className="block-component" />
                      </span>
                      <span data-custom-class="body_text">
                        contact us:{" "}
                        <strong>
                          <a
                            href="../cdn-cgi/l/email-protection.html"
                            className="__cf_email__"
                            data-cfemail="690a1c1a1d06040c1b1a0c1b1f000a0c29040c1d1b00040c06470a0604"
                          >
                            [email&nbsp;protected]
                          </a>
                        </strong>
                    ...
                    <span data-custom-class="body_text">
                      . We will respond to your request within 24h.
                    </span>
                  </span>
                </div>
                <style
